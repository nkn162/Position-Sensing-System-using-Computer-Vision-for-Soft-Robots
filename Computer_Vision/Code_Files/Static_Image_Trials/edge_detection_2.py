...
# Morphological operation to close gaps between edges (smaller kernel for thinner lines)
kernel = np.ones((3, 3), np.uint8)  # Smaller kernel to preserve line thickness
